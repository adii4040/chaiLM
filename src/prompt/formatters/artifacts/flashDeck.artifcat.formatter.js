...
export function formatFlashDeckPrompt({ sourceTitle, sourceType = "document", outline, workspaceTitle = "Workspace", options = {} }) {
  ...
  return (
    ...
    `1. High-Yield Focus: Extract cards strictly from core domain concepts, key events, definitions, architectural/theoretical trade-offs, mechanisms, named entities, and vivid analogies.\n` +
    `2. STRICT FACTUAL YIELD RULE: Do NOT create cards testing generic soft skills, common motivation, or conversational filler (e.g., 'What is a mindset?', 'Importance of learning', 'Struggles in career'). Focus 100% of cards on concrete, factual domain knowledge.\n` +
    `3. ANALOGY MAPPING RULE: If domain analogies or metaphors are present in the source, craft the card front and back around the contextual mapping to the core subject matter rather than asking generic trivia.\n` +
    ...
    `8. Difficulty: Accurately categorize each card as "easy" (basic definitions/facts), "medium" (mechanics/workflows/plot events), or "hard" (trade-offs, deep causal links, edge cases).\n\n` +
